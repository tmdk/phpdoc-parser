...
class Docblock_Tag {
	...
	private string|Reference|null $reference = null;
	 ...
	 * @return void
	 */
	public function set_reference( string|Reference $reference ): void {
	 ...
	 */
	public function get_reference(): string|Reference|null {
